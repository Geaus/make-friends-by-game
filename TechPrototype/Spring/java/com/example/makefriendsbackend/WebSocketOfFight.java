...
@Component
@ServerEndpoint("/websocket/fight/{userId}")
public class WebSocketOfFight {
    /**
     * 日志工具
     */
     ...
     */
    private static CopyOnWriteArraySet<WebSocketOfFight> webSockets = new CopyOnWriteArraySet<>();
    /**
     * 用来存在线连接用户信息
     */
    ...
    public void sendAllMessage(String message) {
        ...
        for (WebSocketOfFight webSocket : webSockets) {
            try {
